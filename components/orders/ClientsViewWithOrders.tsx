                  ...
                  <div className="p-5 pt-3">
                    ...
                    <div className="mb-4">
                      <div className="flex items-center gap-2 mb-2">
                        <h3 className="font-extrabold text-gray-900 text-xl truncate group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-pastel-blue group-hover:to-pastel-beige transition-all">
      ...
      {selectedClient && isMounted && createPortal(
        <>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-pastel-blue to-pastel-beige text-white">
              ...
              <div className="px-3 py-3">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600 truncate">{selectedClient.client.email}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="bg-white/15 rounded-lg p-2 text-center">
                    ...
                    <p className="text-[10px] text-gray-600">Órdenes</p>
                  </div>
                  <div className="bg-white/15 rounded-lg p-2 text-center">
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-gradient-to-b from-gray-50 to-white">
              ...
              <div className="mb-4 sm:mb-6 bg-white rounded-xl shadow-sm p-3 sm:p-6 border-l-4 border-pastel-blue">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 sm:pl-10 pr-9 sm:pr-10 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pastel-blue focus:border-transparent transition-all text-xs sm:text-sm"
                  />
                  {orderSearchTerm && (
                    <button
                ...
                {orderSearchTerm && (
                  ...
                  <div className="px-2 sm:px-3 py-1 bg-pastel-blue/20 text-purple-700 rounded-full flex items-center gap-1.5 sm:gap-2">
                    ...
                    <button
                      onClick={() => setOrderSearchTerm('')}
                      className="ml-0.5 sm:ml-1 hover:bg-pastel-blue/30 rounded-full p-0.5 transition-colors"
                      >
                        <X className="h-3 w-3" />
                      </button>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        <Button
                          ...
                          size="sm"
                          variant="outline"
                          className="text-pastel-blue border-pastel-blue/50 hover:bg-pastel-blue/10 hover:border-pastel-blue transition-all text-xs sm:text-sm h-8 sm:h-9 px-2 sm:px-3"
                        >
