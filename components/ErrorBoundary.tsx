          ...
          <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-pastel-blue to-pastel-beige text-gray-800 px-4 py-2 rounded-lg hover:opacity-90 flex items-center justify-center gap-2"
              >
                <RefreshCw size={16} />
                Reintentar
              </button>
